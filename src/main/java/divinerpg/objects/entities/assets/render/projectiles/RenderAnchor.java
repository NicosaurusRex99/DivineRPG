...
public class RenderAnchor extends Render<EntityAnchor> {
    private static final ResourceLocation FISH_PARTICLES = new ResourceLocation("textures/particle/particles.png");

    public RenderAnchor(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void doRender(EntityAnchor entity, double x, double y, double z, float entityYaw, float partialTicks) {
        EntityPlayer entityplayer = entity.getAngler();
        System.out.println("Entityplayer:" + entityplayer);
        if (entityplayer != null && !this.renderOutlines) {
            ...
            if (!(itemstack.getItem() instanceof ItemAnchor)) {
                k = -k;
            }
    ...
    protected ResourceLocation getEntityTexture(EntityAnchor entity) {
