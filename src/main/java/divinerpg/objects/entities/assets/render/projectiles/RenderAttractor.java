...
public class RenderAttractor extends Render<EntityAttractor> {

    public RenderAttractor(RenderManager manager) {
        super(manager);
    }
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityAttractor entity) {
        return location;
    }
}
