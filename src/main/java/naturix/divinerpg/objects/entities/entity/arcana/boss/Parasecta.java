package naturix.divinerpg.objects.entities.entity.arcana.boss;
...
public class Parasecta extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/arcana/boss/parasecta");
