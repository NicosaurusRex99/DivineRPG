...
public class Samek extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/samek");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Samek.class));
