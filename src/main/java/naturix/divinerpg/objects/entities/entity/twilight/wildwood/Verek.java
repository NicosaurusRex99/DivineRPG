...
public class Verek extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/wildwood/verek");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Verek.class));
