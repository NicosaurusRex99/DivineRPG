...
public class Mystic extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/mystic");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Mystic.class));
