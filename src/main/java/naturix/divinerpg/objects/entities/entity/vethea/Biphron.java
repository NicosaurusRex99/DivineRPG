...
public class Biphron extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/vethea/biphron");
    ...
    protected SoundEvent getAmbientSound() {
        return DRPGSoundHandler.BIPHRON;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return DRPGSoundHandler.BIPHRON_HURT;
    }
