...
public class SkythernCori extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/skythern_cori");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, SkythernCori.class));
