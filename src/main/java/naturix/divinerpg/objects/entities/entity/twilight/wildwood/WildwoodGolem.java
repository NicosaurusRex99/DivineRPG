...
public class WildwoodGolem extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/wildwood/wildwood_golem");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, WildwoodGolem.class));
