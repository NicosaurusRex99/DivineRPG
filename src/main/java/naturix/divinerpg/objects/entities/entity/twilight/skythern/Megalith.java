...
public class Megalith extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/megalith");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Megalith.class));
