...
public class MortumCadillion extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/mortum/mortum_cadillion");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, MortumCadillion.class));
