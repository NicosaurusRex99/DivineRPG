...
public class Epiphite extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/wildwood/epiphite");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Epiphite.class));
