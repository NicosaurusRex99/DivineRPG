...
public class WildwoodTomo extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/wildwood/wildwood_tomo");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, WildwoodTomo.class));
