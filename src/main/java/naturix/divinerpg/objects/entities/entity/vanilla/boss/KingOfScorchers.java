package naturix.divinerpg.objects.entities.entity.vanilla.boss;
...
public class KingOfScorchers extends EntityDivineRPGBoss {
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/vanilla/boss/king_of_scorchers");
    private int special;
