...
public class Mage extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/wildwood/mage");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Mage.class));
