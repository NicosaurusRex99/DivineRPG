...
public class SoulStealer extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/mortum/soul_stealer");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, SoulStealer.class));
