...
public class Greenfeet extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/eden/greenfeet");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Greenfeet.class));
