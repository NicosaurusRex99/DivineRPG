package naturix.divinerpg.objects.entities.entity.twilight.skythern;
...
public class SkythernFiend extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/skythern_fiend");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, SkythernFiend.class));
