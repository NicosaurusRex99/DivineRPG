...
public class Madivel extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/eden/madivel");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, Madivel.class));
