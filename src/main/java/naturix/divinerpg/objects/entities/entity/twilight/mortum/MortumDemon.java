...
public class MortumDemon extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/mortum/mortum_demon");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, MortumDemon.class));
