...
public class SkythernArcher extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/skythern/skythern_archer");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, SkythernArcher.class));
