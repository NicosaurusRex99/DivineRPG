package naturix.divinerpg.objects.entities.entity.twilight.eden;
...
public class SunArcher extends EntityMob {
    ...
    public static final ResourceLocation LOOT = new ResourceLocation(Reference.MODID, "entities/twilight/eden/sun_archer");
    ...
    {
    	this.tasks.addTask(4, new EntityAIFindEntityNearest(this, SunArcher.class));
